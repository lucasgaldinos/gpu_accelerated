...
% change thanks format. https://texdoc.org/serve/titling.pdf/0 2.1.2 Restyling the thanks
...
adotado para citações no texto.'' \url{http://www.abntex.net.br/}} \and
Lauro César Araujo\thanks{``Constar currículo sucinto de cada autor, com 
vinculação corporativa e endereço de contato.''} \and Another author\thanksmark{1}}
