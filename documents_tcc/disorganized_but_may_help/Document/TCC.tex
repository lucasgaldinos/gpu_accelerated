...
\titulo{Avaliação de Meta-heurística para solução do TSP utilizando técnicas de Computação de Alto Desempenho}
...
\section{Next revisions}

\citeonline{koczy2018enhanced} explored a novel approach based on an evolutionary algorithm called DBMEA results in 
...
\bibliography{/home/lucas_galdino/Desktop/TCC/references/references_citations/refs.bib}
